...
gene_ID_table <- read.table("~/IsoDB_Data/gene_IDs_and_names.tsv", header = T)
...
write_gff_data(filter_top_gff(DB_filter_4ex_95perc, 5), "~/IsoDB_Data/fullfilter_top5.gff")
...
plot_splicing(DB_filter_4ex_95perc, example_gene1)
